...
using kafka_sink_st = kafka_sink<blog::spdlog::details::null_mutex>;
...
inline std::shared_ptr<logger> kafka_logger_mt(const std::string &logger_name,
                                               blog::spdlog::sinks::kafka_sink_config config) {
...
template <typename Factory = blog::spdlog::async_factory>
inline std::shared_ptr<blog::spdlog::logger> kafka_logger_async_mt(
    std::string logger_name, blog::spdlog::sinks::kafka_sink_config config) {
    return Factory::template create<sinks::kafka_sink_mt>(logger_name, config);
}

template <typename Factory = blog::spdlog::async_factory>
inline std::shared_ptr<blog::spdlog::logger> kafka_logger_async_st(
    std::string logger_name, blog::spdlog::sinks::kafka_sink_config config) {
    return Factory::template create<sinks::kafka_sink_st>(logger_name, config);
}
