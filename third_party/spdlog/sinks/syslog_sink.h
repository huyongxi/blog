...
public:
    syslog_sink(std::string ident, int syslog_option, int syslog_facility, bool enable_formatting)
        : enable_formatting_{enable_formatting},
          syslog_levels_{{/* blog::spdlog::level::trace      */ LOG_DEBUG,
                          /* blog::spdlog::level::debug      */ LOG_DEBUG,
                          /* blog::spdlog::level::info       */ LOG_INFO,
                          /* blog::spdlog::level::warn       */ LOG_WARNING,
                          /* blog::spdlog::level::err        */ LOG_ERR,
                          /* blog::spdlog::level::critical   */ LOG_CRIT,
                          /* blog::spdlog::level::off        */ LOG_INFO}},
