...
class udp_sink : public blog::spdlog::sinks::base_sink<Mutex> {
public:
...
protected:
    void sink_it_(const blog::spdlog::details::log_msg &msg) override {
        blog::spdlog::memory_buf_t formatted;
        blog::spdlog::sinks::base_sink<Mutex>::formatter_->format(msg, formatted);
...
using udp_sink_st = udp_sink<blog::spdlog::details::null_mutex>;
