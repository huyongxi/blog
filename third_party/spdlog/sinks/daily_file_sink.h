 ...
 * Usages:
 *    auto sink =
 * std::make_shared<blog::spdlog::sinks::daily_file_format_sink_mt>("myapp-%Y-%m-%d:%H:%M:%S.log", hour,
 * minute);" auto logger = blog::spdlog::daily_logger_format_mt("loggername, "myapp-%Y-%m-%d:%X.log",
 * hour,  minute)"
 *
 */
...
private:
    ...
    tm now_tm(log_clock::time_point tp) {
        ...
        return blog::spdlog::details::os::localtime(tnow);
    }
